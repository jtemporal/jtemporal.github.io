...
## Undoing the last commit while keeping the changes (git reset --soft)
...
If you ever go further than a soft reset, say a `git reset --hard`, and lose work in the process, do not panic: the [git reflog](https://jtemporal.com/recovering-lost-commits-with-git-reflog/) can usually bring it back.
