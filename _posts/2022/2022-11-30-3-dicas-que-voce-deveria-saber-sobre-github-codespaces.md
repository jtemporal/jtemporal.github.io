...
![Imagem mostrando a seção de Settings no menu do perfil no GitHub](/images/codespaces/github-menu-selected-option-settings.webp){: style="display: block; margin-left: auto; margin-right: auto; max-width: 30%;"}
...
![Imagem mostrando a seção de Codespaces no menu da esquerda na página de Settings](/images/codespaces/codespaces-lefthand-side-menu-in-settings.webp){: style="display: block; margin-left: auto; margin-right: auto; max-width: 50%;"}

Isso vai te levar para a página de configuração do Codespaces e logo aparece a primeira seção chamada *Dotfiles.*

![Seção de configuração de Dotfiles no Settings antes de usar dotfiles](/images/codespaces/dotfiles-section-on-codespaces-settings.webp)
...
![Seção de configuração de Dotfiles no Settings após ativar o uso de dotfiles](/images/codespaces/dotfiles-section-on-codespaces-settings-configured.webp)
...
![Lista de Codespaces no seu perfil](/images/codespaces/github-codespaces-dashboard.webp)
...
![Imagem mostrando a integração de github com codespaces com um pull request de exemplo](/images/codespaces/github-vscode-extension-in-action.webp)
