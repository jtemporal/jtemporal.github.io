...
description: Um olhar sobre como a funcionalidade Clean Up da Apple Intelligence apaga objetos de fotos no iPhone e iPad, com imagens reais de antes e depois.
...
- edição de fotos
- português
title: 'Apple Intelligence Clean Up: removendo objetos de fotos no iPhone'
translations:
- lang: en
...
Sim, Apple, todos percebemos que você fez.
...
Depois de conseguir todas as minhas fotos, só faltava uma coisinha: fazer este pequeno vídeo usando "apenas uma foto".
