...
comments: true
bookbanner: true
description: "Não sei, mas eu adoraria ver mais projetos e mais gente contribuindo"
related: true
posts_list:
...
translations:
- lang: en
  url: /hacktoberfest-reflections
author_note: false

---

*Esta é uma submissão para o [desafio de escrita do Hacktoberfest 2024](https://dev.to/challenges/hacktoberfest): Experiência de contribuidora*

*Esta é uma submissão para o [desafio de escrita do Hacktoberfest 2024](https://dev.to/challenges/hacktoberfest): Experiência de mantenedora*

*[Também disponível no dev.to aqui](https://dev.to/jesstemporal/reflections-from-a-maintainer-and-contributor-during-hacktoberfest-550j).*

---

Desde 2016, eu faço uma curadoria de [projetos mantidos por pessoas brasileiras para os quais as pessoas podem contribuir durante o Hacktoberfest](https://jtemporal.com/projetos-br-hacktoberfest-2024/). O objetivo é facilitar as contribuições da comunidade de desenvolvimento brasileira e também diminuir a barreira de entrada para a primeira contribuição de código aberto de pessoas brasileiras que podem não falar inglês ou não saber por onde começar.
...
Para mim, o [Hacktoberfest](https://hacktoberfest.com/) é só uma desculpa para retribuir à comunidade, mesmo que durante o ano eu não tenha conseguido fazer muita coisa. Infelizmente, é verdade: muita gente costumava focar em código aberto só durante o Hacktoberfest para ganhar uma camiseta.
...
Recentemente, dei uma palestra relâmpago no Python Brasil, o maior evento de Python da América Latina. Em 2 minutos, falei sobre código aberto e Hacktoberfest. Anunciei que o [GitFichas, uma coleção de cartões de estudo de Git, estava se tornando código aberto](https://jtemporal.com/gitfichas-agora-e-open-source/). E convidei as pessoas a participarem dos sprints de contribuição que aconteceriam no dia seguinte para vários projetos.
