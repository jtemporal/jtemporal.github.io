...
![MCP server blog search flowchart](/images/mcp/flowchart-mcp-server-blog-search.webp){: style="max-width:80%;display: block; margin-left: auto; margin-right: auto;"}
...
![MCP servers section in VS Code Extensions tab](/images/mcp/local-mcp-in-vscode/00-mcp-servers-list.webp)
...
![Starting MCP server configuration in VS Code](/images/mcp/local-mcp-in-vscode/01-mcp-install-in-vscode.webp)
...
![Selecting the stdio transport layer](/images/mcp/local-mcp-in-vscode/02-pick-the-transport-layer.webp)
...
![Entering the command to run your MCP server](/images/mcp/local-mcp-in-vscode/03-command-to-run-your-mcp.webp)
...
![Providing a name for your MCP server](/images/mcp/local-mcp-in-vscode/04-give-the-name-to-your-mcp.webp)
...
![Choosing between workspace and global configuration](/images/mcp/local-mcp-in-vscode/05-choose-workspace.webp)
...
![Trusting the authors of the MCP server](/images/mcp/local-mcp-in-vscode/06-trust-the-authors.webp)
...
![MCP server actions available in the configuration file](/images/mcp/local-mcp-in-vscode/08-mcp-server-actions.webp)
...
![Additional MCP server options in the menu dialog](/images/mcp/local-mcp-in-vscode/09-mcp-server-more-options.webp)
...
![MCP server log output for debugging](/images/mcp/local-mcp-in-vscode/10-mcp-server-log.webp)
...
![Error message when MCP server is misconfigured](/images/mcp/local-mcp-in-vscode/11-mcp-error-menu.webp)
...
![Accessing MCP server logs through the output panel](/images/mcp/local-mcp-in-vscode/12-mcp-log-through-lower-panel.webp)
...
![Your MCP server listed in the Extensions tab](/images/mcp/local-mcp-in-vscode/13-list-of-mcp-servers.webp)
...
![First tool call showing search intent](/images/mcp/local-mcp-in-vscode/14-tool-call.webp)
...
![Secondary tool call to get full content](/images/mcp/local-mcp-in-vscode/15-secondary-tool-call.webp)
...
![Final MCP result displayed in VS Code chat](/images/mcp/local-mcp-in-vscode/16-mcp-result-in-vscode.webp)
