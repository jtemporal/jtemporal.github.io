...
description: Como fazer login no Heroku CLI pelo terminal sem navegador, mesmo com a autenticação multifator (MFA) ativada. Útil no GitHub Codespaces.
...
- authorização
- portugues
title: Login no Heroku via linha de comando (CLI) com MFA ativado
translations:
- lang: en
