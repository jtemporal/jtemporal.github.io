...
description: Renomeie um arquivo no git sem bagunçar o histórico. Aprenda como o git mv renomeia arquivos em um passo só, pro git não achar que você apagou e criou outro.
...
- português
- colinha
title: Renomeando arquivos no Git do jeito certo (usando git mv)
translations:
- lang: en
