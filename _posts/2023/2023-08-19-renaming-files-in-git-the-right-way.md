...
description: Rename a file in git without breaking your history. Learn how git mv renames files in one step so git doesn't think you deleted and recreated them.
...
- english
- protip
title: 'Renaming files in Git: the right way (using git mv)'
translations:
- lang: pt
