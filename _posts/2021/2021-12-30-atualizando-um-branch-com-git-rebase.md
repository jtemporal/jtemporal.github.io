...
Nessa colinha vou te mostrar como usar `git rebase` para atualizar um branch, trazendo os commits mais recentes do main (ou master) para o seu branch de trabalho ficar em dia.
...
![desenho mostrando o estado corrente do histórico](/images/git-rebase-ajustar-origem/git-rebase-origem-fig-11.webp)

Similarmente, o grafo do histórico deverá se mostrar como a imagem abaixo:

![imagem mostrando o branch main com o histórico atualizado](/images/git-rebase-ajustar-origem/git-rebase-origem-fig-8.webp)
...
![imagem com o resultado do comando git log --graph mostrando o ramo tarefa-2 com histórico antes da atualização](/images/git-rebase-ajustar-origem/git-rebase-origem-fig-7.webp)

## Atualizando seu branch a partir do main com git rebase
...
![imagem com o resultado dos comandos anteriores](/images/git-rebase-ajustar-origem/git-rebase-origem-fig-9.webp)
...
![desenho do histórico atualizado após o git rebase](/images/git-rebase-ajustar-origem/git-rebase-origem-fig-12.webp)

E o grafo de histórico deverá se mostrar assim:

![grafo de histórico após atualizar o ramo tarefa-2 com o rebase](/images/git-rebase-ajustar-origem/git-rebase-origem-fig-10.webp)
...
Agora você sabe atualizar um branch usando o rebase, caso queira mais detalhes sobre o comando `git rebase`, recomendo a leitura da [documentação do mesmo em português](https://git-scm.com/docs/git-rebase/pt_BR). E se um rebase der errado e você perder um commit, o [git reflog](/recuperando-commits-perdidos-com-git-reflog/) pode te ajudar a recuperá-lo.
