...
description: O git não acompanha pastas vazias. Veja como o arquivo .gitkeep deixa você commitar um diretório vazio e manter a estrutura de pastas do projeto.
...
- português
- colinha
title: Criando pastas vazias no git com o .gitkeep
translations:
- lang: en
