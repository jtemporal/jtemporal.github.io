...
description: Git doesn't track empty folders. Here's how the .gitkeep file lets you commit an empty directory and keep your project's folder structure.
...
- english
- pro tip
title: Creating empty folders in git with .gitkeep
translations:
- lang: pt
